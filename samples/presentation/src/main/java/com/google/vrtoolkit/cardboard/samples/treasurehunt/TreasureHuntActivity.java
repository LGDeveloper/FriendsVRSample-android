...
public class TreasureHuntActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    private final int PRESENTATION_ANIM_DURATION = 3000;        // ms
    ...
    public void onPause() {
        ...
        // Destroy the PresentationView
        if (mPresentationView != null)
            mPresentationView.destroy();
    ...
    public void onResume() {
        ...
        mPresentationView = new PresentationView(mContext);
    }
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        if (mPresentationView != null)
            mPresentationView.show3DToast("Pull the trigger when you find an object.", true, PRESENTATION_ANIM_DURATION);
    }
    ...
    public void onCardboardTrigger() {
        ...
        if (isLookingAtObject()) {
            hideObject();
            if (mPresentationView != null)
                mPresentationView.show3DToast("Found it! Look around for another one.", true, PRESENTATION_ANIM_DURATION);
        } else {
            if (mPresentationView != null)
                mPresentationView.show3DToast("Look around to find the object!", true, PRESENTATION_ANIM_DURATION);
        }
